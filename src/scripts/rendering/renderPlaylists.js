...
export function renderPlaylists() {
    ...
    playlists.forEach((playlist) => {
        ...
        <div class="flex items-center justify-between p-3 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors duration-200">
            ...
            ${playlist.id !== 1 ? `
            <button id="js-delete-playlist-${playlist.id}" class="text-gray-500 hover:text-red-500 transition-colors duration-200 ml-4 js-delete-playlist-btn" data-playlist-id="${playlist.id}">
